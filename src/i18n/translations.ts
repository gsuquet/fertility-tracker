export const translations = {
  en: {
    ...
    disclaimer: {
      ...
      nonAffiliation: 'Fertility Tracker is an independent open-source software project and is not affiliated with, endorsed by, certified by, or sponsored by the Saint Paul VI Institute, FertilityCare™ Centers of America (FCCA), or FertilityCare™ Centers International (FCCI).',
      medical: 'This software is intended for personal tracking, record-keeping, and educational purposes only. It does not provide medical advice, diagnosis, or treatment. Always consult a certified FertilityCare Practitioner or Medical Consultant for clinical guidance.',
    }
  },
  fr: {
    appTitle: 'Fertility Tracker',
